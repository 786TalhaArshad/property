    ...
    if ($action === 'save') {
        ...
        if ($code === '' || $name === '') {
            ...
            if ($id > 0) {
                ...
                flash('success', 'Expense head updated successfully.');
            } else {
                ...
                flash('success', 'Expense head added successfully.');
            }
        }
...
<div class="toolbar d-flex flex-wrap align-items-center gap-2">
    ...
    <?php if ($canEdit): ?>
    <button class="btn btn-primary ms-auto" data-bs-toggle="modal" data-bs-target="#headModal" data-code="<?= e($nextHeadCode) ?>"><i class="bi bi-plus-lg me-1"></i>Add Expense Head</button>
    <?php endif; ?>
</div>

<div class="card">
    <div class="card-header"><i class="bi bi-diagram-3 me-2"></i>Expense Heads &amp; Sub-Heads</div>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0" id="dataTable">
                ...
                <?php foreach ($heads as $h): ?>
                    <?php $bal = (float)$h['opening_balance'] + (float)$h['total_debit'] - (float)$h['total_credit']; ?>
                    <tr class="table-light fw-semibold">
                        ...
                        <td class="text-end text-nowrap">
                            ...
                            <form method="post" class="d-inline" data-confirm="Delete this expense head?">
                                <?= csrf_field() ?>
                    ...
                    <?php foreach ($subsByParent[$h['id']] ?? [] as $s): ?>
                        <?php $sbal = (float)$s['opening_balance'] + (float)$s['total_debit'] - (float)$s['total_credit']; ?>
                        <tr>
                            <td></td>
                ...
                <?php endforeach; ?>
                <?php if (!$heads): ?>
                    <tr><td colspan="8"><div class="empty-state"><i class="bi bi-diagram-3"></i><p>No expense heads yet</p></div></td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
...
<div class="modal fade" id="headModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post">
                <div class="modal-header"><h5 class="modal-title">Add Expense Head</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
...
(function () {
    ...
    headModal.addEventListener('show.bs.modal', function (e) {
        ...
        headModal.querySelector('.modal-title').textContent = edit ? 'Edit Expense Head' : 'Add Expense Head';
    });
