...
<div class="toolbar d-flex flex-wrap align-items-center gap-2">
    ...
    <?php if ($canEdit): ?>
    <button class="btn btn-primary ms-auto" data-bs-toggle="modal" data-bs-target="#recordModal" data-add="Add Payment Method"><i class="bi bi-plus-lg me-1"></i>Add <?= $label ?></button>
    <?php endif; ?>
</div>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover mb-0" id="dataTable">
                ...
                <?php endforeach; ?>
                <?php if (!$records): ?>
                    <tr><td colspan="3"><div class="empty-state"><i class="bi bi-credit-card"></i><p>No records yet</p></div></td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
